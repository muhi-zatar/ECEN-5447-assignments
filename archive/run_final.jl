...
function run_multimachine_model(network_file)
    ...
    Vd_grd = network_states[V_1_D_IDX]
    Vq_grd = network_states[V_1_Q_IDX]
    ...
    function multimachine_dynamics!(du, u, params, t)
        ...
        # Grab terminal voltage from network at bus 2 (machine bus)
        ...
        # Extract terminal voltage and current from network at bus 1 (inverter bus)
        ...
        # Compute apparent power for the network at inverter bus
        P_terminal_inverter = v_1_d * i_grd_d + v_1_q * i_grd_q
        Q_terminal_inverter = v_1_q * i_grd_d - v_1_d * i_grd_q
        ...
        _, _, _, _, _ = update_network_states!(
            ...
            S_terminal_inverter, # Inverter injection 
            network
        )
...
# Convert line current to rectangular coordinates
        ...
        # Calculate power at machine bus
        ...
        # Calculate power at inverter bus
        P_1 = v_1_d * i_grd_d + v_1_q * i_grd_q
        Q_1 = v_1_q * i_grd_d - v_1_d * i_grd_q
